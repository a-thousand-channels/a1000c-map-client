...
<template>
  <div class="">
    <ul class="pb-10">
      <li v-if="!places.length" class="bg-a100c-white px-4 py-2 rounded shadow mt-4">
      ...
      <li v-else v-for="(place,index) in places" :id="'place-'+place.id" class="bg-a100c-white px-4 py-2 rounded shadow mt-4">
